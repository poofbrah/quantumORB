...
class StrategyConfig:
    ...
    asia_session_window: str = "18:00-03:00"
    london_session_window: str = "03:30-11:30"
    key_zone_start_time: str = "08:00"
    key_zone_end_time: str = "08:15"
    key_zone_min_width_points: float | None = None
    key_zone_max_width_points: float | None = 20.0
    key_zone_min_width_atr: float | None = None
    key_zone_max_width_atr: float | None = None
    invalidate_large_key_zone: bool = True
    trade_window_required: bool = True
    bias_requires_clean_break: bool = False
    clean_bias_lockout_day: bool = True
    bias_min_close_distance_points: float = 0.0
    bias_establish_start_time: str = "08:15"
    midpoint_retrace_required: bool = True
    stop_anchor_sessions: tuple[str, ...] | None = ("asia", "london")
    stop_scan_low_points: float = 5.0
    stop_scan_high_points: float = 10.0
    stop_default_points: float = 8.0
    rr_multiple: float = 4.0
    rp_entry_mode: str = "displacement_vwap_pullback"
    rp_stop_mode: str = "zone_boundary"
    rp_stop_buffer_points: float = 0.0
    rp_partial_at_r: float = 1.0
    rp_partial_fraction: float = 0.5
    rp_move_stop_to_breakeven_after_partial: bool = True
    rp_runner_target_r: float | None = None
    rp_runner_trailing_stop_mode: str = "atr"
    rp_runner_trailing_atr_multiple: float = 1.5
    ...
    rp_reentry_stop_mode: str = "signal_or_range"
    rp_reentry_stop_buffer_points: float = 0.0
    rp_reentry_max_entry_time: str = "10:30"
    rp_reentry_tp1_mode: str = "vwap_or_mid"
    rp_reentry_partial_fraction: float = 0.5
    rp_reentry_breakeven_after_tp1: bool = True
    bos_lookback_bars: int = 3
    bos_require_same_direction_candle: bool = True
    bos_invalidate_on_opposite_zone_break: bool = True
